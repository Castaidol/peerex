...
class PaymentViewController: UIViewController, STPPaymentContextDelegate {
    ...
    let backendBaseURL = "https://boiling-castle-76624.herokuapp.com/transactionapi"
    ...
    init(product: String, price: Int, settings: Settings) {
        ...
        //assert(stripePublishableKey.hasPrefix("pk_test_SCmjTpTsIyclK12cSKCjtaUt"), "You must set your Stripe publishable key at the top of CheckoutViewController.swift to run this app.")
        //assert(backendBaseURL != "https://boiling-castle-76624.herokuapp.com/transactionapi", "You must set your backend base url at the top of CheckoutViewController.swift to run this app.")
